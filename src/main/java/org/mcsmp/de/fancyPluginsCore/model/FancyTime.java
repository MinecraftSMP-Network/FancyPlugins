 ...
 */
@Getter
public final class FancyTime implements ConfigStringSerializable {
	 ...
	 */
	private FancyTime(@NonNull final String time) {
	...
	public boolean equals(final Object obj) {
		return obj instanceof FancyTime && ((FancyTime) obj).timeTicks == this.timeTicks;
	}
	 ...
	 * @return
	 */
	public static FancyTime fromSeconds(final int seconds) {
	 ...
	 * @return
	 */
	public static FancyTime fromString(final String time) {
		return new FancyTime(time);
	}
}

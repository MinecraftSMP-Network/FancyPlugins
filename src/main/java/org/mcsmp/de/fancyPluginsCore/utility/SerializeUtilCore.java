...
public abstract class SerializeUtilCore {
	...
	public static Object serialize(final Language language, final Object object) {
		...
		// Shortcut for our own classes
			...
			for (final Map.Entry<TextDecoration, TextDecoration.State> entry : style.decorations().entrySet())
		...
		else if (object instanceof FancyComponent)
	...
	public static <T> T deserialize(@NonNull final Language language, @NonNull final Class<T> classOf, @NonNull Object object, final Object... parameters) {
		...
		else if (classOf == FancyComponent.class)
